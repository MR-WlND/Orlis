...
<body class="login-select-body">
    <div class="container">
        <h1>{{ __('messages.choose_login_role') }}</h1>
        <div class="roles">
            <a href="{{ route('role.login', ['role' => 'admin']) }}" class="role-card">
                <div class="role-name">👨‍💼 Admin</div>
                <div class="role-desc">{{ __('messages.admin_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'admin']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>

            <a href="{{ route('role.login', ['role' => 'manager']) }}" class="role-card">
                <div class="role-name">📊 Manager</div>
                <div class="role-desc">{{ __('messages.manager_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'manager']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>

            <a href="{{ route('role.login', ['role' => 'staff']) }}" class="role-card">
                <div class="role-name">👔 Staff</div>
                <div class="role-desc">{{ __('messages.staff_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'staff']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>
            ...
            <a href="{{ route('role.login', ['role' => 'customer']) }}" class="role-card">
                ...
                <div class="role-desc">{{ __('messages.customer_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'customer']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>
            ...
            <a href="{{ route('role.login', ['role' => 'shipper']) }}" class="role-card">
                ...
                <div class="role-desc">{{ __('messages.shipper_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'shipper']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>
            ...
            <a href="{{ route('role.login', ['role' => 'warehouse_staff']) }}" class="role-card">
                ...
                <div class="role-desc">{{ __('messages.warehouse_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'warehouse_staff']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>

            <a href="{{ route('role.login', ['role' => 'supplier']) }}" class="role-card">
                <div class="role-name">🏭 Supplier</div>
                <div class="role-desc">{{ __('messages.supplier_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'supplier']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>

            <a href="{{ route('role.login', ['role' => 'guest']) }}" class="role-card">
                <div class="role-name">👤 Guest</div>
                <div class="role-desc">{{ __('messages.guest_role_desc') }}</div>
                <a href="{{ route('role.login', ['role' => 'guest']) }}" class="role-btn">{{ __('messages.login') }}</a>
            </a>
        </div>
    </div>
</body>
